...
parseconf_bool_array[] = {{"pasv_enable", &tunable_pasv_enable}, {"port_enable", &tunable_port_enable}, {NULL, NULL}};
...
parseconf_uint_array[] = {{"listen_port", &tunable_listen_port},
...
parseconf_str_array[] = {{"listen_address", &tunable_listen_address}, {"ftp_user_message", &ftp_user_message}, {NULL, NULL}};
...
void parseconf_load_file(const char *path)
{
    ...
    {
        if (strlen(setting_line) == 0 || setting_line[0] == '#' || str_all_space(setting_line)) continue;
